...
inline std::vector<std::string> demoEvents() {
    return {
        ...
        R"({"type":"BeliefDeltaApplied","schemaVersion":1,"eventId":"ev-7","timestamp":"t0","taskId":"task-1","frameId":"frame-1","delta":{"id":"delta-2","frameId":"frame-1","producerPhase":"propose","operation":"propose","resultBeliefId":"belief-2","resultingBeliefs":[{"id":"belief-2","statement":"runtime environment provides the declared dependencies","domain":"product","expectation":"every declared dependency is importable","evidenceRounds":1,"skillRefs":[],"supportedBy":[],"refutedBy":[],"withdrawn":false}]},"activeBeliefs":["belief-1","belief-2"]})",
        ...
        // ---- Distillation writes back only its own belief deltas ----
        R"({"type":"BeliefDeltaApplied","schemaVersion":1,"eventId":"ev-14a","timestamp":"t1","taskId":"task-1","frameId":"frame-1","delta":{"id":"delta-3","frameId":"frame-1","producerPhase":"distill","operation":"support","beliefId":"belief-1","sourceBeliefId":"belief-1","resultBeliefId":"belief-1","evidence":"requirements declares pytest","resultingBeliefs":[{"id":"belief-1","statement":"project uses pytest","domain":"code","expectation":"pytest is importable","evidenceRounds":1,"skillRefs":[],"supportedBy":[{"evidence":"requirements declares pytest"}],"refutedBy":[],"withdrawn":false}]},"activeBeliefs":["belief-1","belief-2"]})",
        R"({"type":"BeliefDeltaApplied","schemaVersion":1,"eventId":"ev-14b","timestamp":"t1","taskId":"task-1","frameId":"frame-1","delta":{"id":"delta-4","frameId":"frame-1","producerPhase":"distill","operation":"refute","beliefId":"belief-2","sourceBeliefId":"belief-2","resultBeliefId":"belief-2","evidence":"pytest is unavailable","resultingBeliefs":[{"id":"belief-2","statement":"runtime environment provides the declared dependencies","domain":"product","expectation":"every declared dependency is importable","evidenceRounds":1,"skillRefs":[],"supportedBy":[],"refutedBy":[{"evidence":"pytest is unavailable"}],"withdrawn":false}]},"activeBeliefs":["belief-1"]})",
        R"({"type":"DistillationProduced","schemaVersion":1,"eventId":"ev-14","timestamp":"t1","taskId":"task-1","frameId":"frame-1","distillation":{"id":"distillation-1","inputs":["exec-1","exec-2"],"contents":"declared dependency and actual runtime environment differ","outputs":["delta-3","delta-4"]}})",
