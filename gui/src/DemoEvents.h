...
inline std::vector<std::string> demoEvents() {
    return {
        ...
        R"({"type":"BeliefDeltaApplied","schemaVersion":1,"eventId":"ev-6","timestamp":"t0","taskId":"task-1","frameId":"frame-1","delta":{"id":"delta-1","frameId":"frame-1","operation":"propose","beliefId":"belief-1","resultingBeliefs":[{"id":"belief-1","statement":"project uses pytest","domain":"code","expectation":"pytest is importable","evidenceRounds":1,"skillRefs":[],"supportedBy":[],"refutedBy":[],"withdrawn":false}]},"activeBeliefs":["belief-1"]})",
        R"({"type":"BeliefDeltaApplied","schemaVersion":1,"eventId":"ev-7","timestamp":"t0","taskId":"task-1","frameId":"frame-1","delta":{"id":"delta-2","frameId":"frame-1","operation":"propose","beliefId":"belief-2","resultingBeliefs":[{"id":"belief-2","statement":"runtime environment provides the declared dependencies","domain":"product","expectation":"every declared dependency is importable","evidenceRounds":1,"skillRefs":[],"supportedBy":[],"refutedBy":[],"withdrawn":false}]},"activeBeliefs":["belief-1","belief-2"]})",
