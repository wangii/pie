...
export interface CreateAgentSessionOptions {
	 ...
	 *   (read, bash, edit, write, view_frame_action_graph) but keep extension/custom tools enabled
	 */
	noTools?: "all" | "builtin";
	/**
	 ...
	 * (read, bash, edit, write, view_frame_action_graph) and leaves extension/custom tools enabled
	...
	/** Context projection policy. Defaults to Pie's Phase 4 Observation compiler. */
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	const defaultActiveToolNames = ["read", "bash", "edit", "write", "view_frame_action_graph"];
