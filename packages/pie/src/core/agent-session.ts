...
export class AgentSession {
	...
	/**
	 * With a non-empty scoped-model list, the persisted default is also appended to that
	 * scope and to the enabled-models list, so a model persisted while cycling stays
