...
For TypeScript definitions in your project, inspect `node_modules/@earendil-works/pi-pie/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@earendil-works/pi-pie";
