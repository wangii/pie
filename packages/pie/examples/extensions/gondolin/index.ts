 ...
 *
 * Setup:
 *   cd packages/pie/examples/extensions/gondolin
 *   npm install --ignore-scripts
 *
 * Usage:
 *   cd /path/to/project
 *   pi -e /path/to/pi/packages/pie/examples/extensions/gondolin
 *
 * Requirements:
...
import type { ExtensionAPI, ExtensionContext } from "@earendil-works/pi-pie";
import {
	type BashOperations,
	createBashTool,
	createEditTool,
